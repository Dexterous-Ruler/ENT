...
export const mockIntentData = [
  { name: 'Pricing', value: 35, color: 'oklch(0.65 0.18 72)' },
  { name: 'Appointments', value: 28, color: 'oklch(0.55 0.12 175)' },
  { name: 'Services', value: 20, color: 'oklch(0.62 0.14 145)' },
  { name: 'Order Status', value: 12, color: 'oklch(0.62 0.12 240)' },
  { name: 'Hours', value: 5, color: 'oklch(0.75 0.15 70)' },
];

export const mockLanguageData = [
  { name: 'Hindi', value: 45, color: 'oklch(0.65 0.18 72)' },
  { name: 'Tamil', value: 22, color: 'oklch(0.55 0.12 175)' },
  { name: 'Telugu', value: 15, color: 'oklch(0.62 0.14 145)' },
  { name: 'Marathi', value: 10, color: 'oklch(0.62 0.12 240)' },
  { name: 'Bengali', value: 8, color: 'oklch(0.75 0.15 70)' },
];
...
export const businessTypes = [
  {
    ...
    name: 'Kirana Store',
    nameHi: 'किराना स्टोर',
    description: 'Grocery, general store, daily needs',
    descriptionHi: 'किराना, जनरल स्टोर, दैनिक ज़रूरतें',
  },
  {
    id: 'clinic',
    icon: '🏥',
    name: 'Clinic',
    nameHi: 'क्लीनिक',
    description: 'Doctor, dentist, pathology lab',
    descriptionHi: 'डॉक्टर, दंत चिकित्सक, पैथोलॉजी लैब',
  },
  {
    id: 'coaching',
    icon: '📚',
    ...
    nameHi: 'कोचिंग सेंटर',
    description: 'Tuition, test prep, skill training',
    descriptionHi: 'ट्यूशन, टेस्ट प्रेप, स्किल ट्रेनिंग',
  },
  {
    id: 'mechanic',
    icon: '🔧',
    name: 'Mechanic / Garage',
    nameHi: 'मैकेनिक / गैरेज',
    description: 'Auto repair, bike service, car wash',
    descriptionHi: 'ऑटो रिपेयर, बाइक सर्विस, कार वॉश',
  },
  {
    id: 'travel',
    icon: '✈️',
    name: 'Travel Agent',
    nameHi: 'ट्रैवल एजेंट',
    description: 'Tickets, tours, visa services',
    descriptionHi: 'टिकट, टूर, वीज़ा सेवाएँ',
  },
  {
    id: 'salon',
    icon: '💇',
    ...
    descriptionHi: 'हेयर, ब्यूटी, ग्रूमिंग',
  },
];

export const languages = [
  { code: 'hi', name: 'Hindi', nameNative: 'हिन्दी', speakers: '528M' },
  { code: 'ta', name: 'Tamil', nameNative: 'தமிழ்', speakers: '78M' },
  { code: 'te', name: 'Telugu', nameNative: 'తెలుగు', speakers: '83M' },
  { code: 'mr', name: 'Marathi', nameNative: 'मराठी', speakers: '83M' },
  { code: 'bn', name: 'Bengali', nameNative: 'বাংলা', speakers: '100M' },
  { code: 'kn', name: 'Kannada', nameNative: 'ಕನ್ನಡ', speakers: '44M' },
  { code: 'gu', name: 'Gujarati', nameNative: 'ગુજરાતી', speakers: '55M' },
  { code: 'or', name: 'Odia', nameNative: 'ଓଡ଼ିଆ', speakers: '35M' },
  { code: 'ml', name: 'Malayalam', nameNative: 'മലയാളം', speakers: '38M' },
  { code: 'pa', name: 'Punjabi', nameNative: 'ਪੰਜਾਬੀ', speakers: '33M' },
  { code: 'as', name: 'Assamese', nameNative: 'অসমীয়া', speakers: '15M' },
  { code: 'ur', name: 'Urdu', nameNative: 'اردو', speakers: '69M' },
];
